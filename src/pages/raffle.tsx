...
import {Connection,PublicKey, Transaction, Keypair,ConfirmOptions,clusterApiUrl,SYSVAR_CLOCK_PUBKEY} from '@solana/web3.js'
...
export default function Raffle(){
	...
	const getAllRaffles = async() => {
		...
		for(let item of resp){
			let raffleData = await program.account.raffle.fetch(item.pubkey) as any
...
{/*		<div className='m-2'>
		...
		
		{
			isLoading ?
				<div>
					<CircularProgress size="15rem" disableShrink color="info"></CircularProgress>
				</div>
			:
			id === "" ?
